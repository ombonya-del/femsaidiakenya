...
const SEED_PERPS = [
  {
    id:'1',
    name:'Joseph Kuria Irungu',
    alias:'Jowie',
    crime_type:'Murder/Femicide',
    conviction_date:'2024-02-09',
    sentence:'Death sentence (sentenced March 13, 2024)',
    case_number:'High Court Criminal Case — Milimani Law Courts, Nairobi',
    county:'Nairobi',
    status:'Incarcerated',
    court_record_url:'https://nation.africa/kenya/news/monica-kimani-murder-court-sentences-jowie-4554636',
  },
  {
    id:'2',
    name:'Billington Wambui Mwathi',
    alias:null,
    crime_type:'Murder/Femicide',
    conviction_date:'2023-12-19',
    sentence:'30 years imprisonment',
    case_number:'Nyeri High Court — Karatina',
    county:'Nyeri',
    status:'Incarcerated',
    court_record_url:'https://76crimes.com/2023/12/23/killer-of-kenyan-lesbian-sentenced-to-30-years/',
  },
  {
    id:'3',
    name:'Fredrick Odhiambo Owuor',
    alias:null,
    crime_type:'Murder/Femicide',
    conviction_date:'2024-06-25',
    sentence:'35 years imprisonment',
    case_number:'Criminal Case E002 of 2022 — Kisumu High Court',
    county:'Kisumu',
    status:'Incarcerated',
    court_record_url:'https://new.kenyalaw.org/akn/ke/judgment/kehc/2024/7722/eng@2024-06-25',
  },
  {
    id:'4',
    name:'Eliud Kipchoge Tum',
    alias:null,
    crime_type:'Murder/Femicide',
    conviction_date:'2024-01-01',
    sentence:'Custodial sentence — 2024',
    case_number:'Uasin Gishu High Court',
    county:'Uasin Gishu',
    status:'Incarcerated',
    court_record_url:'https://africauncensored.online/blog/2025/01/25/how-2024-became-the-deadliest-year-for-women-in-kenya/',
  },
  {
    id:'5',
    name:'Moses Njoroge',
    alias:null,
    crime_type:'GBV/Assault',
    conviction_date:'2020-01-01',
    sentence:'5 years imprisonment',
    case_number:'High Court — Nairobi',
    county:'Nairobi',
    status:'Released',
    court_record_url:'https://allafrica.com/stories/202403050236.html',
  },
]
