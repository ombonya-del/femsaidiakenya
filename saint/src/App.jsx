      ...
      <nav style={{ background:SURF, borderBottom:`1px solid ${BD}`,
        ...
        <div style={{ display:'flex', alignItems:'center', gap:8 }}>
          <span style={{ fontFamily:"'Lora',serif", fontSize:20, fontWeight:700, cursor:'pointer' }}
            ...
            <span style={{ color:TXT }}>Sa</span><span style={{ color:RED }}><span style={{ position:'relative', display:'inline-block' }}>I<span style={{ position:'absolute', top:'-0.08em', left:'50%', transform:'translateX(-50%)', width:'0.18em', height:'0.18em', borderRadius:'50%', background:'#FFFFFF', display:'block' }}/></span>nt</span>
          </span>
          <span style={{ fontFamily:"'Nunito Sans',sans-serif", fontSize:8,
